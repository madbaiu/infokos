            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center pt-3 pb-3">
                        <span class="db"><img src="<?php echo e(asset('template/assets/images/logo1.png')); ?>" alt="logo" /></span>
                    </div>
                    <!-- Form -->

                    <form class="form-horizontal mt-3" action="<?php echo e(route('login')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <div class="row pb-4">
                            <div class="col-12">
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="pt-3">
                                        <a class="btn btn-info" id="to-recover" href="<?php echo e(url('/')); ?>"></i> Kembali ke
                                            Beranda</a>
...
</html><?php /**PATH D:\xampp\htdocs\Projek\bayu\resources\views/auth/login.blade.php ENDPATH**/ ?>